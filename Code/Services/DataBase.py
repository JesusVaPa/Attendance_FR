...
#myProfessor = Professor("Fode")
#print(DataBase.postProfessor(myProfessor))
#DataBase.getProfessors()
#DataBase.updateProfessor(myProfessor,5)
#print(DataBase.deleteProfessor(5))

#myCourse = Course("Math")
#print(DataBase.postCourse(myCourse))

#myStudent = Student("Jesus")
#print(DataBase.postStudent(myStudent))
